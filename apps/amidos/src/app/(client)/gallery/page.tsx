...
export default function Home() {
  ...
  const images = ['/restaurant/1.png', '/restaurant/2.png', '/restaurant/3.png', '/restaurant/4.png', '/restaurant/5.png'];

  return (
    <div className="m-auto w-[1000px] pb-10">
      <h1 className="text-5xl font-bold text-gray-600 pt-8">AMIDO'S GALLERY</h1>
