  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: 'p-0 size-8 text-sm flex-1 flex items-center justify-center has-[button]:hover:!bg-[#52071B] rounded-md has-[button]:hover:aria-selected:!bg-[#52071B] has-[button]:hover:text-accent-foreground has-[button]:hover:aria-selected:text-primary-foreground',
        ...
        selected: 'bg-[#52071B] text-primary-foreground hover:!bg-[#52071B] hover:text-primary-foreground focus:bg-[#52071B] focus:text-primary-foreground',
        today: 'bg-[#52071B]/80 text-accent-foreground',
