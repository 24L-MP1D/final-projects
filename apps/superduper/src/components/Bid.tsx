        ...
        <div className="flex flex-col gap-2 pt-8 px-4">
          ...
          <label className="border-solid bg-[#f8f7f8] flex gap-1 items-center py-1 px-3 w-full shadow-sm">
            ...
            <Input
              ...
              className="w-full p-2 bg-[#f8f7f8] rounded-lg"
          ...
          <div className="flex gap-1 w-full">
            <Button type="submit" className="flex-1 hover:bg-blue-500 active:bg-blue-400 hover:text-white border-[1px] py-2 px-4 bg-white text-blue-500 text-center shadow-md btn">
              Үнийн санал оруулах
            </Button>
          </div>
        </div>
