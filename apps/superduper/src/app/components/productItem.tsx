    ...
    <CardContainer containerClassName="p-0 w-full h-auto " key={product.productName} className="hover:cursor-pointer">
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full rounded-xl p-6 border h-auto">
        ...
        <CardItem translateZ="100" className="w-full mt-4">
          <Image loading="lazy" alt={product.frontImage} src={product.frontImage} width={100} height={100} className="!w-full !h-[200px] !object-cover rounded-md" />
        </CardItem>
        ...
        <div className="flex justify-between items-center">
          <CardItem translateZ={20} href="https://twitter.com/mannupaaji" target="__blank" className="text-sm bg-slate-200 text-blue-700 h-[25px] rounded-xl  mt-3 text-nowrap px-5 font-semibold">
